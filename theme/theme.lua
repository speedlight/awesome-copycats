--[[
     ...
     Speedlight Awesome WM theme
     github.com/speedlight
...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/speedlight"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(30), fg = theme.fg_normal, bg = theme.bg_normal })
